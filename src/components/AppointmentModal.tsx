...
export default function AppointmentModal({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      Promise.all([
        ...
        .catch((err) => {
          console.error("Error loading vets/rooms:", err);
          setError("Failed to load vets and rooms data");
        })
        .finally(() => {
  ...
  }, [isOpen, appointment, reset, dataLoading]); // Add dataLoading as dependency
